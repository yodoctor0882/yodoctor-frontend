...
//   return (
//     <div
//       className={`relative bg-white rounded-2xl p-[18px] flex flex-col gap-3.5 transition-all duration-200 cursor-default ${
//         hovered
...
//         </div>
//         <button
//           className="w-8 h-8 rounded-full flex items-center justify-center hover:bg-gray-100 transition flex-shrink-0 bg-gray-200"
//           onClick={() => setMenuOpen(!menuOpen)}
//         >
//           <span className="text-[20px] leading-none text-[#101215]">⋮</span>
//         </button>
//       </div>
...
//       {menuOpen && (
//         <div className="absolute top-12 right-4 w-44 bg-white border border-gray-200 rounded-xl shadow-xl overflow-hidden z-50">
//           <button
//             onClick={() => {
//               setMenuOpen(false);

//               const confirmDelete = window.confirm(
//                 "Are you sure you want to delete your certificate?",
//               );

//               if (confirmDelete) {
//                 console.log("Delete", rawCert.id);

//                 // delete API yaha call karna
//               }
//             }}
...
//             </div>
//             <div className="text-[14px] font-mono" style={{ color: "#4b5e7a" }}>
